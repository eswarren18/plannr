...
def is_line_short_enough(  # noqa: C901
    ...
    if (
        str_width(first) > mode.line_length
        or str_width(last) > mode.line_length
    ):
        return False
    ...
    max_level_to_update: Union[int, float] = (
        math.inf
    ...
    for i, leaf in enumerate(line.leaves):
        ...
        if (
            ...
            if (line.inside_brackets or leaf.bracket_depth > 0) and (
                i != len(line.leaves) - 1
                or leaf.prev_sibling not in ignore_ctxs
            ):

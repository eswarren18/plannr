...
def _run_legacy(
    hook_type: str, hook_dir: str, args: Sequence[str]
) -> tuple[int, bytes]:
...
def _validate_config(
    retv: int, config: str, skip_on_missing_config: bool
) -> None:
...
def _pre_push_ns(
    color: bool, args: Sequence[str], stdin: bytes
...
def _run_ns(
    hook_type: str, color: bool, args: Sequence[str], stdin: bytes
) -> argparse.Namespace | None:

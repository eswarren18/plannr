...
def warn_unknown_keys_root(
    extra: Sequence[str], orig_keys: Sequence[str], dct: dict[str, str]
) -> None:
...
LOCAL_HOOK_DICT = cfgv.Map(
    'Hook', 'id', *MANIFEST_HOOK_DICT.items, *_COMMON_HOOK_WARNINGS
)
CONFIG_REPO_DICT = cfgv.Map(
    ...
    cfgv.ConditionalRecurse(
        'hooks', cfgv.Array(LOCAL_HOOK_DICT), 'repo', LOCAL
    ),

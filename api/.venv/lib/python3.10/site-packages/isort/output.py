...
def sorted_imports(
    ...
    for section in sections:
        ...
        lines_between = [""] * (
            ...
            if from_modules and straight_modules
            else 0
        )
            ...
            for from_import in copy.copy(from_imports):
                if from_import in as_imports:
                    ...
                    if parsed.imports[section]["from"][module][from_import]:
                        ...
                        from_imports[idx : (idx + 1)] = as_imports.pop(
                            from_import
                        )
        ...
        while from_imports:
            ...
            if "*" in from_imports and config.combine_star:
                import_statement = wrap.line(
                    with_comments(
                        _with_star_comments(
                            parsed, module, list(comments or ())
                        ),
                        f"{import_start}*",
                ...
                while from_imports and (
                    ...
                    or (
                        ...
                        and parsed.imports[section]["from"][module][
                            from_import
                        ]
                    )
                ):
                ...
                if (
                    force_grid_wrap
                    and len(from_import_section) >= force_grid_wrap
                ):
        ...
        for module in straight_modules:
            if module in parsed.categorized_comments["above"]["straight"]:
                above_comments.extend(
                    parsed.categorized_comments["above"]["straight"].pop(
                        module
                    )
                )
...
def _with_star_comments(
    ...
    star_comment = (
        parsed.categorized_comments["nested"].get(module, {}).pop("*", None)
    )
    if star_comment:

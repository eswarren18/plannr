...
def _explicitly_chosen(
    *, option: list[str] | None, extend: list[str] | None
) -> tuple[str, ...]:
...
class DecisionEngine:
    ...
    def __init__(self, options: argparse.Namespace) -> None:
        ...
        self.selected_explicitly = _explicitly_chosen(
            option=options.select, extend=options.extend_select
        )
        self.ignored_explicitly = _explicitly_chosen(
            option=options.ignore, extend=options.extend_ignore
        )
    ...
    def make_decision(self, code: str) -> Decision:
        ...
        LOG.debug(
            "The user configured %r to be %r, %r", code, selected, ignored
        )

...
class PythonInfo:  # noqa: PLR0904
    ...
    def __init__(self) -> None:  # noqa: PLR0915
        ...
        # pointer size.
        self.architecture = (
            32 if struct.calcsize("P") == 4 else 64
        )  # noqa: PLR2004
        ...
        for element in self.sysconfig_paths.values():
            config_var_keys.update(
                k[1:-1] for k in _CONF_VAR_RE.findall(element)
            )
    ...
    def satisfies(self, spec, impl_must_match):  # noqa: C901, PLR0911
        ...
        if (
            spec.free_threaded is not None
            and spec.free_threaded != self.free_threaded
        ):
            return False
